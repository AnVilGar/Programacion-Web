...
if (mysqli_num_rows($resultado) > 0) {
    ...
    echo '<tr><th style="padding: 10px;">ID publicación</th><th style="padding: 10px;">Título</th><th style="padding: 10px;">Tipo de Actividad</th><th style="padding: 10px;">Ruta GPX</th><th style="padding: 10px;">Compañero de Actividad</th><th style="padding: 10px;">Aplausos</th><th style="padding: 10px;">Imagen</th></tr>';
    ...
    while ($row = mysqli_fetch_assoc($resultado)) {
        ...
        echo '<td style="padding: 8px;">' . $row['ruta_gpx'] . '</td>';
        ...
        echo '<form action="mostrar_ruta_admin.php" method="post"><input type="hidden" name="ruta_gpx" value="' . $row['ruta_gpx'] . '"><input type="submit" value="Mostrar ruta"></form>';
        echo '</td>';
        echo '</tr>';
    }
    ...
    echo 'No se encontraron publicaciones para el usuario con ID ' . $id_usuario;
    echo '<a href="administrador.php"><input type="button" value="Volver a inicio"></a>';
